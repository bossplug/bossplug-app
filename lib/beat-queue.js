...
module.exports =  class BeatQueue {
     ...
     async  init()
    {
      ...
      var testaudio = {path:'/home/andy/Music/Function Loops - FREE SAMPLES - Future Music/Festival Trance 2/DRUMS/DRUM_03_TRIO_STRIPPED_138bpm.wav'};

      var player = AV.Player.fromFile(testaudio);
      // player.play();  //test  -- should send stream out ?


       this.playToSpeaker(testaudio)
