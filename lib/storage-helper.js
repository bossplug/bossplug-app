...
module.exports =  class StorageHelper {
  constructor( ){
    ...
    static getStoragePath()
    {
      ...
      static async  storeConfigFile(key,json)
      {
      ...
      static async hasConfigFile(key)
      {
        var response = await new Promise((resolve, reject) => {
      ...
      static async readConfigFile(key)
      {
        var response = await new Promise((resolve, reject) => {
    ...
    static async showOpenDialog(prop)
    {
      var path = dialog.showOpenDialog(prop);

      return path;
    }

    static async showSaveDialog(prop)
    {
      var path = dialog.showSaveDialog(prop);
