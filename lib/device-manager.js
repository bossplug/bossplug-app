...
module.exports =  class DeviceManager {
    ...
    async pressedPad(x,y,pressed)
    {
      ...
      if(pressed)
      {
        ...
        this.queuePadColor(i,Launchpad.Colors.green);
      }else{
        this.queuePadColor(i,Launchpad.Colors.red);
      }
  ...
  /*  async setPadColor(k)
    ...
    async queuePadColor(i, padColor)
    {
      ...
      queuedPadColors.push([x,y,padColor])
    ...
    async update()
    {
      ...
      if(queuedPadColors && queuedPadColors.length > 0)
      {
        await this.setPadColorByArray(queuedPadColors)
        queuedPadColors = [];
      }
